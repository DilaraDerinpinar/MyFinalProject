...
namespace Core.DataAccess
{
    //generic constraint
    //class:referans tip
    //IEntity : IEntity olabilir veya onu implemente eden nesne olabilir.
    ...
    public interface IEntityRepository<T> where T:class,IEntity,new()
    {
        ...
        List<T> GetAll(Expression<Func<T,bool>> filter=null); //FİLTER=NULL IN ANLAMI FİLTRE VERMEYEBİLİRSİN DE VEREBİLİLRSİN DE ANLAMINDA
